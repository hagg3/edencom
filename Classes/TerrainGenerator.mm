...
void TerrainGenerator::generateEmptyColumn(int cx,int cz){
    int ocx=cx;
	int ocz=cz;
...
void TerrainGenerator::generateCloud(){
 ...
 */
void TerrainGenerator::placeTree(int x,int z,int y){
	//
