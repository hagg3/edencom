...
enum SOUND_TYPES{
    ...
    S_GOOP_EXPLODE=51,
    S_METAL_DESTROY=52,
    S_MENU_BUTTON_PRESS=53,
    S_MENU_BUTTON_RELEASE=54,
    S_SKY_CHANGE_DARK_TO_LIGHT=55,
    S_SKY_CHANGE_LIGHT_TO_DARK=56,
    S_SKY_PAINTING=57,
    S_WARP_HOME_ACTIVATED=58,
    S_WARP_HOME_LOCATION_SET=59,
    S_WORLD_SAVED=60,
    S_EXIT_WORLD=61,
    // menu_button_press/release_01.mp3 sound noticeably different from variations 02-05 (the web
    // port's settings-panel switch toggles are the only place that's wanted) — pulled out of the
    // S_MENU_BUTTON_PRESS/RELEASE random-variation pool below and given their own single-variation
